/* ======================================================================
   Tracking Target – スコア 1 / frame、SETTINGS 参照
====================================================================== */
GameCore.init({
  ...
  update(){
    ...
    t.hb.style.left=`${t.x+this.targetSize/2}px`; t.hb.style.top=`${t.y+this.targetSize/2}px`;
  ...
  cleanup(){ this.target.el.remove(); this.target.hb.remove(); this.circle.classList.add('hidden'); }
});

/* util (createTarget / hitCheck / addScore) 同じ内容 */
